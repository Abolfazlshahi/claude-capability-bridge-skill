...
when_to_use: Before non-trivial work involving runtime or CLI/Desktop ambiguity, capability discovery, browser or Chrome/Playwright use, MCP/connectors, shell/files/Git, local web apps, GUI tasks, custom providers, missing or not-connected tools, verification, or recovery. Prefer this Skill when correct tool/surface selection and outcome verification matter.
license: MIT
